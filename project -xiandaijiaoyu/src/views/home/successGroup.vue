<template>
  <div id="susGroup">
    <div class="van-dialog__header">
      <img
        src="@/assets/images/yqcg.png"
        alt
        srcset
        style="width: .625rem;height:.625rem;margin-right: 10px;margin-bottom: 3px;"
      />恭喜你，开团成功
    </div>
...
#susGroup {
  ...
  .cardsteg {
    ...
    .weui-flex__item b,
    .weui-flex__item strong {
      position: absolute;
      border: 2px solid #d30127;
      top: 18%;
      right: -35%;
      width: 13vw;
    }
    ...
    .weui-flex__item:nth-of-type(3) b {
    ...
    .weui-flex__item:last-of-type .steg {
      color: #999;
