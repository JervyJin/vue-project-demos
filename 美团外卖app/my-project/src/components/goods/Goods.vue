<template>
  <div class="goods">
    ...
    <div class="foods-wrapper" ref="foodScroll">
      <ul>
        ...
        <li v-for="(item,index) in goods" :key="index" class="food-list food-list-hook">
          ...
          <!-- 具体商品分类 -->
          <ul>
            <li v-for="(food,index) in item.spus" @click="showDetail(food)" :key="index" class="food-item">
    ...
    <!-- 商品详情 -->
    <app-product-detail :food="food" ref="foodView"></app-product-detail>
  </div>
</template>
...
export default {
  ...
  methods:{
    ...
    //点击商品展示详情，将数据赋值给属性以属性传值的方式给需要的组件
    showDetail(food){
      this.food = food
